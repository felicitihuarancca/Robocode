...
public class RouteFinder {
	...
	public static void main(String[] args) {
		...
		Problema problema=new Problema(nFil,nCol,numObstaculos,semilla);
		...
		// *especificacion de todos los robots, guardados en este array
		...
		// *se guardan los parametros con la que se colocaran inicialmente los robots en el campo de batalla
		robotSetups[indice]=new RobotSetup( (double)problema.f_inicial,        //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE A LA POSICIÃ“N INICIAL DEL ROBOT de la clase problema
											(double)problema.c_inicial,        //AQUÃ� DEBE FIGURAR LA COLUMNA EN PIXELS CORRESPONDIENTE A LA POSICIÃ“N INICIAL DEL ROBOT de la clase problema   
		...
		for (int f = 0; f < nFil; f++){
			for (int c = 0; c < nCol; c++){
				if(problema.matriz[f][c]==0) {//SI HAY OBSTÃ�CULO EN ESA POSICIÃ“N DE LA MALLA
					//*la fila tal y la malla tal aqui hay un obstaculo? eso es lo que se tiene que preguntar
					
					existingRobots[indice]=modelRobots[0];   //sittingDuck
					
					
					robotSetups[indice]=  new RobotSetup( (double) f,   //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE AL CENTRO DE LA CELDA DONDE HAY OBSTÃ�CULO
							                               (double) c,   //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE AL CENTRO DE LA COLUMNA DONDE HAY OBSTÃ�CULO
							                             0.0);    //orientaciÃ³n
					indice++;
